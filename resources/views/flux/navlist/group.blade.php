...
>
    <button
        type="button"
        class="group/disclosure-button mb-[2px] flex h-10 w-full items-center rounded-lg text-zinc-500 hover:bg-zinc-800/5 hover:text-zinc-800 lg:h-8 _dark:text-white/80 _dark:hover:bg-white/[7%] _dark:hover:text-white"
    >
        <div class="ps-3 pe-4">
    ...
    <div class="relative hidden space-y-[2px] ps-7 data-open:block" @if ($expanded === true) data-open @endif>
        <div class="absolute inset-y-[3px] start-0 ms-4 w-px bg-zinc-200 _dark:bg-white/30"></div>
